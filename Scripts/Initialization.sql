...
-- Основная таблица для физических лиц
CREATE TABLE person (
...
CREATE TABLE association_farms (
    ...
    status ENUM('active', 'inactive', 'suspended') NOT NULL DEFAULT 'active',
    notes TEXT,
    CONSTRAINT pk_association_farms PRIMARY KEY (association_id, farm_id),
...
-- Производимый продукт на участке
...
-- Потребляемый продукт на участке
...
/*=================================
5. Контракты (договоры с поставщиками)
===================================*/
